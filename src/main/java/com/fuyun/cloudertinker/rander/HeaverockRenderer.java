 ...
 */
public class HeaverockRenderer extends EntityRenderer<HeaveRock> {
//实体渲染器
	public HeaverockRenderer(EntityRendererProvider.Context manager) {
		super(manager);
		this.shadowRadius = 0.5F;
	}

	@Override
	public void render(HeaveRock entity, float yaw, float partialTicks, PoseStack ms, MultiBufferSource buffers, int light) {
	...
	@Override
	public ResourceLocation getTextureLocation(HeaveRock entity) {
