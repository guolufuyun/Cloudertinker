        ...
        if (toolAttackContext.getLivingTarget() != null) {
            ...
            if (attacker instanceof ServerPlayer player){
                ...
                if (hunger <6){   entity.invulnerableTime = 0;
                    entity.hurt(entity.damageSources().mobAttack(attacker),modifierEntry.getLevel() * ((20-hunger) + v1 * (8-hunger) /8));

                    player.getFoodData().setFoodLevel(20);
                } else {
                    entity.setRemainingFireTicks((100 * modifierEntry.getLevel()));
                    entity.hurt(entity.damageSources().inFire(), (float) (v1 * 0.15 * modifierEntry.getLevel()));
            ...
            entity.setLastHurtByMob(toolAttackContext.getAttacker());
        }
