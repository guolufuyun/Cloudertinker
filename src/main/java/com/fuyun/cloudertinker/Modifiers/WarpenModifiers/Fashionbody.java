...
public class Fashionbody extends BattleModifier  {
    ...
    public void spawnAnimal(Level world, Entity entity, LivingEntity summoner) {
        if (enabled) {
            ...
            if (summoner.getCommandSenderWorld().getEntitiesOfClass(LoyalZombie.class,new AABB(summoner.blockPosition()).inflate(15)).size()<11) {
