...
public class Sacrificeblood extends ArmorModifier {
    ...
    public void onFinishUsing(IToolStackView tool, ModifierEntry modifier, LivingEntity entity) {
        ...
        if ( instance != null) {
            ...
            player.hurt(TFDamageTypes.getDamageSource(level ,TFDamageTypes.EXPIRED), 5.0F);
            ...
            player.hurt(TFDamageTypes.getDamageSource(level ,TFDamageTypes.EXPIRED), 5 * modifier.getLevel() );
